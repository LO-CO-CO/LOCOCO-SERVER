...
public class CreatorGetService {
    ...
    public boolean isCreatorNameAvailable(String creatorName, Long excludeCreatorId) {
        Creator currentCreator = creatorRepository.findById(excludeCreatorId).orElse(null);
